...
return [
    ...
    'stack' => [
        [
            'group' => 'Frontend',
            'items' => ['JavaScript', 'HTML5', 'CSS3', 'Tailwind CSS', 'Bootstrap'],
        ],
        [
            'group' => 'Backend',
            'items' => ['Laravel', 'Node.js', 'PHP', 'MongoDB', 'MySQL'],
        ],
        [
            'group' => 'DevOps & Cloud',
            'items' => ['Figma', 'GitHub', 'Git', 'AWS', 'GitHub Actions'],
        ],
    ],
    'links' => [
    ...
    'beyondCoding' => 'When not coding, I stay active and productive through learning, fitness, and community activities. These help me maintain balance, creativity, and focus while improving as a developer.',
    'projects' => [
